...
\purple{\textbf{Pestilenz}: Alle die das Haus betreten erhalten +2 Pestilenz.}
...
\purple{\textbf{Pestilenz}: Kümmern sich die Spieler weiter um die Kinder erhalten sie +1 Pestilenz.}
...
\begin{center}
  \input{./Informationen/chap/Räuber.tex}
\end{center}
...
\begin{itemize}
  ...
  \item \textbf{Mittlere Türe}: Die mittlere Türe ist geschlossen. Öffnen die Spieler diese erhalten sie \purple{+2 Pestilenz}. Hinter der Türe liegt ein Raum der bis auf einen großen Tisch in der Mitte leer ist. Auf dem Tisch liegt nackt ein Toter mit aufgeschnittenem Bauch. Auch in den Ecken liegen mehrere Tote, die meisten von ihnen von der Pest gezeichnet.
...
\purple{\textbf{Pestilenz}: Alle Spieler die gebissen werden erhalten einmalig +1 Pestilenz.}
