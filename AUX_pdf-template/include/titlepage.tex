...
\begin{titlepage}
	...
	\begin{tikzpicture}[remember picture,overlay,every node/.style={inner sep=0,outer sep=0}]
		...
		\node[anchor=north west] at ($(current page.north west) + (\tpbinding + \tpborder + \tplogooffset-16mm, -\tpborder -\tplogooffset)$) {\includegraphics[width=50mm]{img/header.pdf}};
		...
		\node[anchor=south] at ($(pagebotcenter) + (-8mm,\tpbotborder + 60mm)$)
		{
			\begin{minipage}{160mm}
				\centering
				\framebox{\includegraphics[width=0.7\textwidth]{img/header.jpg}}
			\end{minipage}
		};
